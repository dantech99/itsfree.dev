...
export const freeTiers: Record<string, LocalizedFreeTier> = {
  ...
  "Uploadcare": { en: "Free: 3,000 uploads/month, 10 GB storage and 30 GB traffic with image transformations.", es: "Gratis: 3.000 subidas/mes, 10 GB de storage y 30 GB de tráfico con transformaciones de imagen." },
